...
import { EventProvider, TtyPlayer, MAX_SIZE, Buffer } from './ttyPlayer';
...
describe('lib/term/ttyPlayer/eventProvider', () => {
  ...
  describe('init()', () => {
    it('should load events and initialize itself', async () => {
      ...
      jest.spyOn(provider, '_fetchContent').mockImplementation(() => Promise.resolve());
  ...
  describe('fetchContent()', () => {
    it('should fetch session content', async () => {
      ...
      jest.spyOn(provider, '_fetchEvents')
        .mockImplementation(() => Promise.resolve(provider._createEvents(sample.events)));
  ...
  describe('new()', () => {
   ...
   describe('connect()', () => {
    ...
    it('should initialize event provider', async() => {
      ...
      let wasCalled = false
      ttyPlayer.on('change', () => { wasCalled = true} );
