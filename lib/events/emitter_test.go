	...
	testCases := []testCase{
		{
			...
			events:         GenerateSession(SessionParams{PrintEvents: 1}),
		},
		{
		...
		},
		{
			...
			minUploadBytes: 1024,
			events:         GenerateSession(SessionParams{PrintEvents: 1000}),
		},
		{
			name:           "no events",
		...
		},
		{
			...
			minUploadBytes: 1,
			events:         GenerateSession(SessionParams{PrintEvents: 0})[:1],
		},
	}
